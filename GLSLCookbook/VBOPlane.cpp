...
VBOPlane::VBOPlane(GLSLProgram *program, float xsize, float zsize, int xdivs, int zdivs, const string &vertexPos, 
				   const string &vertexNormal, const string &vertexTex,float smax, float tmax) : mProgram(program){
	...
	GLuint progHandle = mProgram->getProgram();
	...
	int texLoc = glGetAttribLocation(progHandle, vertexTex.c_str());
